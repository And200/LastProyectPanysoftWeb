...
class MeasureUnitResourceIT {
    ...
    void createMeasureUnit() throws Exception {
        ...
        restMeasureUnitMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(measureUnitDTO))
            )
    ...
    void putNewMeasureUnit() throws Exception {
        ...
        restMeasureUnitMockMvc
            .perform(
                put(ENTITY_API_URL_ID, measureUnitDTO.getId())
    ...
    void putWithMissingIdPathParamMeasureUnit() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restMeasureUnitMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(measureUnitDTO)))
    ...
    void patchNonExistingMeasureUnit() throws Exception {
        ...
        restMeasureUnitMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, measureUnitDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(measureUnitDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamMeasureUnit() throws Exception {
        ...
        restMeasureUnitMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(measureUnitDTO))
            )
            .andExpect(status().isMethodNotAllowed());
