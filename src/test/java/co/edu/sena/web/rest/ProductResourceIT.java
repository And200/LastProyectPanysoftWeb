...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productName(DEFAULT_PRODUCT_NAME).buyPrice(DEFAULT_BUY_PRICE);
        // Add required entity
        Category category;
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productName(UPDATED_PRODUCT_NAME).buyPrice(UPDATED_BUY_PRICE);
        // Add required entity
        Category category;
        if (TestUtil.findAll(em, Category.class).isEmpty()) {
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productName(UPDATED_PRODUCT_NAME).buyPrice(UPDATED_BUY_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME).buyPrice(UPDATED_BUY_PRICE);
