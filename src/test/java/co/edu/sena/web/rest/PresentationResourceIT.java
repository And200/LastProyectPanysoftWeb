...
class PresentationResourceIT {
    ...
    void createPresentation() throws Exception {
        ...
        restPresentationMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(presentationDTO))
            )
    ...
    void putNewPresentation() throws Exception {
        ...
        restPresentationMockMvc
            .perform(
                put(ENTITY_API_URL_ID, presentationDTO.getId())
    ...
    void putWithMissingIdPathParamPresentation() throws Exception {
        ...
        restPresentationMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(presentationDTO))
            )
    ...
    void patchNonExistingPresentation() throws Exception {
        ...
        restPresentationMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, presentationDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(presentationDTO))
            )
            .andExpect(status().isBadRequest());
