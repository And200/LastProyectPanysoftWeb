...
class InventoryResourceIT {
    ...
    public static Inventory createEntity(EntityManager em) {
        Inventory inventory = new Inventory().stocks(DEFAULT_STOCKS);
        // Add required entity
        Product product;
    ...
    public static Inventory createUpdatedEntity(EntityManager em) {
        Inventory inventory = new Inventory().stocks(UPDATED_STOCKS);
        // Add required entity
        Product product;
        if (TestUtil.findAll(em, Product.class).isEmpty()) {
    ...
    void putNewInventory() throws Exception {
        ...
        updatedInventory.stocks(UPDATED_STOCKS);
    ...
    void fullUpdateInventoryWithPatch() throws Exception {
        ...
        partialUpdatedInventory.stocks(UPDATED_STOCKS);
