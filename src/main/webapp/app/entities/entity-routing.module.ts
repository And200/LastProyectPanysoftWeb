...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'detail-amount-recip',
        data: { pageTitle: 'panysoftApp.detailAmountRecip.home.title' },
        loadChildren: () => import('./detail-amount-recip/detail-amount-recip.module').then(m => m.DetailAmountRecipModule),
      },
      {
        path: 'provider',
