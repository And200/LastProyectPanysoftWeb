...
public interface DetailOrderRepository extends JpaRepository<DetailOrder, Long> {
    ...
    @Query(
        value = "select distinct detailOrder from DetailOrder detailOrder left join fetch detailOrder.provider left join fetch detailOrder.orderPlaced left join fetch detailOrder.product",
    ...
    @Query(
        "select distinct detailOrder from DetailOrder detailOrder left join fetch detailOrder.provider left join fetch detailOrder.orderPlaced left join fetch detailOrder.product"
    )
